...
const Kpis = () => {
    ...
    return (
        <div className="flex flex-wrap py-2">
            <div className="flex flex-col items-center  m-1 w-60 bg-blue-500 text-white rounded shadow-xl">
            ...
            <div className="flex flex-col items-center p-2 m-1 w-60 bg-orange-500 text-white rounded shadow-xl">
            ...
            <div className="flex flex-col items-center p-2 m-1 w-60 bg-green-500 text-white rounded shadow-xl">
                <span className="text-lg font-semibold">Eggs</span>
                <span className="text-2xl font-bold">1500 <span>Grams</span></span>
            </div>
            <div className="flex flex-col items-center p-2 4 m-1 w-60 bg-red-500 text-white rounded shadow-xl">
            ...
            <div className="flex flex-col items-center p-2 4 m-1 w-60 bg-blue-500 text-white rounded  shadow-xl">
